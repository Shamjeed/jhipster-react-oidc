package com.demo.oidc.repository;

import com.demo.oidc.JhipsterOidcApp;
import com.demo.oidc.config.Constants;
import com.demo.oidc.config.audit.AuditEventConverter;
import com.demo.oidc.domain.PersistentAuditEvent;
...
import static com.demo.oidc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
